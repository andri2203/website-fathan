                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-body">
                                                                    <img src="<?= "/uploads/{$row['id_pemesan']}/transaksi/{$row['bukti_pembayaran']}" ?>" alt="" class="img-fluid">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                                ...
                                                                <div class="modal-body">
                                                                    <form>
                                                                        <div class="form-group row border-bottom">
                                                                            ...
                                                                            <div class="col-sm-9">
                                                                                <input type="text" readonly class="form-control-plaintext" value="<?= $row['pengirim'] ?> (<?= $row['telpon'] ?>)">
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group row border-bottom">
